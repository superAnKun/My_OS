...
void tss_init() {
	...
	*((struct gdt_desc*)0xc0000933) = make_gdt_desc((uint32_t*)0, 0xfffff, GDT_DATA_ATTR_LOW_DPL3,\
			GDT_ATTR_HIGH);
	//*((struct gdt_desc*)0xc000093b) = make_gdt_desc((uint32_t*)0, 0xfffff, GDT_CODE_ATTR_LOW_DPL3,\
			GDT_ATTR_HIGH);
	//*((struct gdt_desc*)0xc0000943) = make_gdt_desc((uint32_t*)0, 0xfffff, GDT_DATA_ATTR_LOW_DPL3,\
			GDT_ATTR_HIGH);
